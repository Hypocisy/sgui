...
public class SnakeGui extends LayeredGui {
	...
	public SnakeGui(ServerPlayer player) {
		...
		var reg = player.registryAccess().holderOrThrow(Registries.BANNER_PATTERN);

		NUMBERS = new ItemStack[]{
				create(new BannerPatternLayers.Builder().add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_BOTTOM), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_LEFT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_TOP), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_RIGHT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_DOWNLEFT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.BORDER), DyeColor.GRAY).build()),
				create(new BannerPatternLayers.Builder().add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_CENTER), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.SQUARE_TOP_LEFT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.CURLY_BORDER), DyeColor.GRAY).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_BOTTOM), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.BORDER), DyeColor.GRAY).build()),
				create(new BannerPatternLayers.Builder().add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_TOP), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.RHOMBUS_MIDDLE), DyeColor.GRAY).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_BOTTOM), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_DOWNLEFT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.BORDER), DyeColor.GRAY).build()),
				create(new BannerPatternLayers.Builder().add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_BOTTOM), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_MIDDLE), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_TOP), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.CURLY_BORDER), DyeColor.GRAY).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_RIGHT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.BORDER), DyeColor.GRAY).build()),
				create(new BannerPatternLayers.Builder().add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_LEFT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.HALF_HORIZONTAL_MIRROR), DyeColor.GRAY).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_RIGHT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_MIDDLE), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.BORDER), DyeColor.GRAY).build()),
				create(new BannerPatternLayers.Builder().add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_BOTTOM), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.RHOMBUS_MIDDLE), DyeColor.GRAY).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_TOP), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_DOWNRIGHT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.BORDER), DyeColor.GRAY).build()),
				create(new BannerPatternLayers.Builder().add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_BOTTOM), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_RIGHT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.HALF_HORIZONTAL), DyeColor.GRAY).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_MIDDLE), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_TOP), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_LEFT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.BORDER), DyeColor.GRAY).build()),
				create(new BannerPatternLayers.Builder().add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_DOWNLEFT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_TOP), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.BORDER), DyeColor.GRAY).build()),
				create(new BannerPatternLayers.Builder().add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_DOWNLEFT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_TOP), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.BORDER), DyeColor.GRAY).build()),
				create(new BannerPatternLayers.Builder().add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_LEFT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.HALF_HORIZONTAL_MIRROR), DyeColor.GRAY).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_MIDDLE), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_TOP), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_RIGHT), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.STRIPE_BOTTOM), DyeColor.WHITE).add(reg.value().getHolderOrThrow(BannerPatterns.BORDER), DyeColor.GRAY).build()),
		};
