...
public enum ScreenProperty {
    ...
    /**
     * To get the id use {@link net.minecraft.core.registries.BuiltInRegistries#POTION}
     * and call {@code getKey(Object)} on it, for example:
     * {@code BuiltInRegistries.POTION.getKey(potionInstance)}.
     */
